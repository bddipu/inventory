...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(1040, 562)
        self.widget_app = QWidget(MainWindow)
        self.widget_app.setObjectName(u"widget_app")
        self.widget_app.setMinimumSize(QSize(900, 500))
        self.mainLayout = QVBoxLayout(self.widget_app)
...
"}")
        ...
        self.frame_exitMenu = QFrame(self.frame_LMenuMdl)
...
"}")
        ...
        self.verticalLayout.addWidget(self.frame_exitMenu)
...
"}")
        ...
        self.btn_itemIn.setMinimumSize(QSize(40, 40))
        self.btn_itemIn.setMaximumSize(QSize(16777215, 40))
        self.btn_itemIn.setFont(font)
        icon9 = QIcon()
        icon9.addFile(u":/images/images/cil-check.png", QSize(), QIcon.Normal, QIcon.Off)
        self.btn_itemIn.setIcon(icon9)
        ...
        self.frame_pageReceive_2 = QFrame(self.pageReview)
        self.frame_pageReceive_2.setObjectName(u"frame_pageReceive_2")
        self.frame_pageReceive_2.setGeometry(QRect(30, 20, 803, 490))
        sizePolicy.setHeightForWidth(self.frame_pageReceive_2.sizePolicy().hasHeightForWidth())
        self.frame_pageReceive_2.setSizePolicy(sizePolicy)
        self.frame_pageReceive_2.setStyleSheet(u"")
        self.frame_pageReceive_2.setFrameShape(QFrame.NoFrame)
        self.frame_pageReceive_2.setFrameShadow(QFrame.Raised)
        self.frame_pageReceiveDetails_2 = QFrame(self.frame_pageReceive_2)
        self.frame_pageReceiveDetails_2.setObjectName(u"frame_pageReceiveDetails_2")
        self.frame_pageReceiveDetails_2.setGeometry(QRect(0, 0, 742, 220))
        sizePolicy2.setHeightForWidth(self.frame_pageReceiveDetails_2.sizePolicy().hasHeightForWidth())
        self.frame_pageReceiveDetails_2.setSizePolicy(sizePolicy2)
        self.frame_pageReceiveDetails_2.setMinimumSize(QSize(0, 220))
        self.frame_pageReceiveDetails_2.setMaximumSize(QSize(16777215, 220))
        self.frame_pageReceiveDetails_2.setFrameShape(QFrame.NoFrame)
        self.frame_pageReceiveDetails_2.setFrameShadow(QFrame.Raised)
        self.frame_45 = QFrame(self.frame_pageReceiveDetails_2)
        self.frame_45.setObjectName(u"frame_45")
        self.frame_45.setGeometry(QRect(10, 3, 626, 48))
        self.frame_45.setFrameShape(QFrame.StyledPanel)
        self.frame_45.setFrameShadow(QFrame.Raised)
        self.horizontalLayout_55 = QHBoxLayout(self.frame_45)
        ...
        self.horizontalLayout_55.addWidget(self.frame_46)
        ...
        self.inType_cmb_2 = QComboBox(self.frame_34)
        self.inType_cmb_2.setObjectName(u"inType_cmb_2")
        self.inType_cmb_2.setFont(font3)

        self.horizontalLayout_40.addWidget(self.inType_cmb_2)
        ...
        self.inType_cmb_4 = QComboBox(self.frame_47)
        self.inType_cmb_4.setObjectName(u"inType_cmb_4")
        self.inType_cmb_4.setFont(font3)

        self.horizontalLayout_54.addWidget(self.inType_cmb_4)


        self.horizontalLayout_55.addWidget(self.frame_47)

        self.frame_48 = QFrame(self.frame_pageReceiveDetails_2)
        self.frame_48.setObjectName(u"frame_48")
        self.frame_48.setGeometry(QRect(0, 80, 710, 46))
        ...
        self.inDate_dt_2 = QDateEdit(self.frame_40)
        self.inDate_dt_2.setObjectName(u"inDate_dt_2")
        self.inDate_dt_2.setMinimumSize(QSize(200, 0))
        self.inDate_dt_2.setMaximumSize(QSize(16777215, 16777215))
        self.inDate_dt_2.setFont(font3)
        self.inDate_dt_2.setCalendarPopup(True)

        self.horizontalLayout_47.addWidget(self.inDate_dt_2)


        self.horizontalLayout_57.addWidget(self.frame_40)
        ...
        self.horizontalLayout_56.addWidget(self.label_20)

        self.inDate_dt_3 = QDateEdit(self.frame_49)
        self.inDate_dt_3.setObjectName(u"inDate_dt_3")
        self.inDate_dt_3.setMinimumSize(QSize(200, 0))
        self.inDate_dt_3.setMaximumSize(QSize(16777215, 16777215))
        self.inDate_dt_3.setFont(font3)
        self.inDate_dt_3.setCalendarPopup(True)

        self.horizontalLayout_56.addWidget(self.inDate_dt_3)


        self.horizontalLayout_57.addWidget(self.frame_49)

        self.frame_24 = QFrame(self.frame_pageReceiveDetails_2)
        self.frame_24.setObjectName(u"frame_24")
        self.frame_24.setGeometry(QRect(20, 140, 721, 51))
        self.frame_24.setFrameShape(QFrame.StyledPanel)
        self.frame_24.setFrameShadow(QFrame.Raised)
        self.frame_32 = QFrame(self.frame_24)
        self.frame_32.setObjectName(u"frame_32")
        self.frame_32.setGeometry(QRect(10, 10, 382, 27))
        ...
        self.horizontalLayout_33.setContentsMargins(0, 0, 0, 0)
        self.outInfo_lbl_4 = QLabel(self.frame_32)
        self.outInfo_lbl_4.setObjectName(u"outInfo_lbl_4")
        self.outInfo_lbl_4.setMinimumSize(QSize(120, 0))
        self.outInfo_lbl_4.setMaximumSize(QSize(100, 16777215))
        self.outInfo_lbl_4.setFont(font3)
        self.outInfo_lbl_4.setAlignment(Qt.AlignRight|Qt.AlignTrailing|Qt.AlignVCenter)

        self.horizontalLayout_33.addWidget(self.outInfo_lbl_4)

        self.inDescription_txt_2 = QLineEdit(self.frame_32)
        self.inDescription_txt_2.setObjectName(u"inDescription_txt_2")
        self.inDescription_txt_2.setMinimumSize(QSize(200, 0))
        self.inDescription_txt_2.setMaximumSize(QSize(16777215, 16777215))
        self.inDescription_txt_2.setFont(font4)
        self.inDescription_txt_2.setStyleSheet(u"")
        self.inDescription_txt_2.setAlignment(Qt.AlignLeading|Qt.AlignLeft|Qt.AlignVCenter)

        self.horizontalLayout_33.addWidget(self.inDescription_txt_2)

        self.frame_44 = QFrame(self.frame_pageReceive_2)
        self.frame_44.setObjectName(u"frame_44")
        self.frame_44.setGeometry(QRect(350, 380, 235, 40))
        self.frame_44.setMinimumSize(QSize(200, 40))
        ...
        self.btn_itemIn_2 = QPushButton(self.frame_44)
        self.btn_itemIn_2.setObjectName(u"btn_itemIn_2")
        self.btn_itemIn_2.setMinimumSize(QSize(40, 40))
        self.btn_itemIn_2.setMaximumSize(QSize(16777215, 40))
        self.btn_itemIn_2.setFont(font)
        self.btn_itemIn_2.setIcon(icon9)
        self.btn_itemIn_2.setIconSize(QSize(24, 24))

        self.horizontalLayout_51.addWidget(self.btn_itemIn_2)

        self.horizontalSpacer_17 = QSpacerItem(40, 20, QSizePolicy.Expanding, QSizePolicy.Minimum)

        self.horizontalLayout_51.addItem(self.horizontalSpacer_17)

        self.frame_receive_tbl_2 = QFrame(self.frame_pageReceive_2)
        self.frame_receive_tbl_2.setObjectName(u"frame_receive_tbl_2")
        self.frame_receive_tbl_2.setGeometry(QRect(0, 351, 276, 121))
        sizePolicy3.setHeightForWidth(self.frame_receive_tbl_2.sizePolicy().hasHeightForWidth())
        self.frame_receive_tbl_2.setSizePolicy(sizePolicy3)
        self.frame_receive_tbl_2.setFrameShape(QFrame.NoFrame)
        self.frame_receive_tbl_2.setFrameShadow(QFrame.Raised)
        self.verticalLayout_31 = QVBoxLayout(self.frame_receive_tbl_2)
        self.verticalLayout_31.setSpacing(0)
        self.verticalLayout_31.setContentsMargins(0, 0, 0, 0)
        self.verticalLayout_31.setObjectName(u"verticalLayout_31")
        self.verticalLayout_31.setContentsMargins(10, 10, 10, 10)
        self.received_tbl_2 = QTableWidget(self.frame_receive_tbl_2)
        self.received_tbl_2.setObjectName(u"received_tbl_2")
        sizePolicy1.setHeightForWidth(self.received_tbl_2.sizePolicy().hasHeightForWidth())
        self.received_tbl_2.setSizePolicy(sizePolicy1)

        self.verticalLayout_31.addWidget(self.received_tbl_2)
...
"}")
        ...
        self.mainLayout.addWidget(self.frame_app)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.btn_exitMenuText.setText(QCoreApplication.translate("MainWindow", u"Exit", None))
        ...
        self.review_db_cmb.setItemText(0, QCoreApplication.translate("MainWindow", u"Stock Movement", None))
        self.review_db_cmb.setItemText(1, QCoreApplication.translate("MainWindow", u"Inbound Data", None))
        self.review_db_cmb.setItemText(2, QCoreApplication.translate("MainWindow", u"Usage Data", None))
        self.review_db_cmb.setItemText(3, "")
        ...
        self.label_19.setText(QCoreApplication.translate("MainWindow", u"Date Received :", None))
        self.label_20.setText(QCoreApplication.translate("MainWindow", u"Date Received :", None))
        self.outInfo_lbl_4.setText(QCoreApplication.translate("MainWindow", u"Description :", None))
        self.inDescription_txt_2.setText("")
        self.btn_itemIn_2.setText(QCoreApplication.translate("MainWindow", u"     Add to Stock", None))
