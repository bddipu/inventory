...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.btn_appLogo.setStyleSheet(u"qproperty-iconSize: 24px;")
        icon = QIcon()
        icon.addFile(u":/images/images/app_icon.png", QSize(), QIcon.Normal, QIcon.Off)
        self.btn_appLogo.setIcon(icon)
        self.btn_appLogo.setFlat(True)
...
"}")
        ...
        self.btn_minimizeApp.setIcon(icon1)
        ...
        self.btn_maximizeApp.setIcon(icon2)
        ...
        self.btn_closeApp.setIcon(icon3)
        ...
        icon4 = QIcon()
        icon4.addFile(u":/icons/images/icons/icon_menu.png", QSize(), QIcon.Normal, QIcon.Off)
        self.btn_toggleMenu.setIcon(icon4)
        ...
        self.label_toggleMenu.setFont(font1)
        ...
        self.frame_LMenuMdl.setMinimumSize(QSize(0, 0))
        ...
        self.btn_userMenu.setIcon(icon5)
        ...
        self.label_userMenu.setFont(font1)
        ...
        icon6 = QIcon()
        icon6.addFile(u":/icons/images/icons/cil-view-column.png", QSize(), QIcon.Normal, QIcon.Off)
        self.btn_stockMenu.setIcon(icon6)
        ...
        self.label_stockMenu.setFont(font1)
